...
1. 下载最新版本：[ai-news-0.1.0.zip](https://github.com/Scott1743/ai-news/releases/download/v0.1.0/ai-news-0.1.0.zip)
...
0.1.0 的首个公开版本，确立了五阶段工作流（解析请求、研究、筛选去重、报告、Mneme 存储）与"预览再写入"契约。依赖已安装的 [Mneme](https://github.com/Scott1743/mneme) 技能提供知识库与只读审计；本技能不复制或重新实现 Mneme，只通过其公开的 dream 工作流协作。
